...
<div class="container-fluid">
  ...
  <table class="table table-striped">
    ...
    $stmt = connexion()->prepare('SELECT e.nom,e.prenom,e.datenee,e.age,e.adresse,e.optione,e.id_niveau,n.niveaux,f.matiere FROM etudiant AS e JOIN niveau AS n  ON e.id_niveau = n.id LEFT JOIN filiere AS f ON f.id = e.id_matiere  ORDER BY  e.nom ASC, e.prenom ASC ');
    $stmt->execute();
